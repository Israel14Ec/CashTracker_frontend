...
import { BudgetsApiResponseShema } from "@/src/schemas";
import { formatCurrency, formatDate } from "@/src/utils";
import { Metadata } from "next";
import Link from "next/link";

export const metadata: Metadata = {
  title: "Cashtraker - Panel Administración",
  description: "Cashtraker - Panel Administración",
};
...
async function getUserBudgets() {
  ...
  const budgets = BudgetsApiResponseShema.parse(json);
  return budgets;
}
